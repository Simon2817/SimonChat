...
#include <memory>
#include "../../simonchat/logindialog.h"
...
QT_MOC_LITERAL(1, 12, 26), // "SignalSwitchRegisterDialog"
QT_MOC_LITERAL(2, 39, 0) // ""

    },
    "LoginDialog\0SignalSwitchRegisterDialog\0"
    ""
};
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalSwitchRegisterDialog(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginDialog::SignalSwitchRegisterDialog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginDialog::SignalSwitchRegisterDialog()
{
